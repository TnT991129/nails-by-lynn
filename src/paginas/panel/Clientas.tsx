    ...
    <div className="p-5 space-y-4">
      <div className="flex items-center justify-between gap-2">
        ...
        <Link to="/panel/clientas/nueva"
          className="min-h-[44px] px-4 inline-flex items-center rounded bg-rosa-600 text-white text-[14px] font-medium">
          + Nueva
        </Link>
      </div>
      <input value={busq} onChange={e => setBusq(e.target.value)}
        placeholder="Buscar por nombre, teléfono o @instagram"
        className="w-full min-h-[48px] px-4 rounded border border-rosa-200 text-[16px]" />
